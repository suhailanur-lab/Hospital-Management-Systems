...
This project is a simple hospital management system written in Java using OOP concepts.
It includes classes like Doctor, Patient, Nurse, and Surgery.
The program shows how these interact and also calculates a patient bill.
